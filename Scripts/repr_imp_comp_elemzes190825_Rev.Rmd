...
write.csv(repr, file="ImpCompBA_repr.csv")
...
repr <- read.csv("ImpCompBA_repr.csv")
...
## save the plot
# ggsave("repr_groups_final.jpg", width=25, height=18, units="cm")
...
ggsave("repr_severity_final.jpg", gridExtra::arrangeGrob(g_severity_gb, g_severity_w, g_severity_ex, g_severity_buy, g_severity_int), 
