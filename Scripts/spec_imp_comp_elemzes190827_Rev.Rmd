...
gaming_raw <- gaming_raw[gaming_raw$Age > 18, ]
...
ggsave("../Figures/spec_severity_final.jpg", gridExtra::arrangeGrob(g_severity_gb, g_severity_gam, g_severity_ex, g_severity_buy, g_severity_groom),
